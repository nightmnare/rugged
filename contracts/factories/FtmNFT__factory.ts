...
import type { FtmNFT, FtmNFTInterface } from "../FtmNFT";
...
export class FtmNFT__factory {
  static readonly abi = _abi;
  static createInterface(): FtmNFTInterface {
    return new utils.Interface(_abi) as FtmNFTInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): FtmNFT {
    return new Contract(address, _abi, signerOrProvider) as FtmNFT;
  }
}
