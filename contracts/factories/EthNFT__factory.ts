...
import type { EthNFT, EthNFTInterface } from "../EthNFT";
...
export class EthNFT__factory {
  static readonly abi = _abi;
  static createInterface(): EthNFTInterface {
    return new utils.Interface(_abi) as EthNFTInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): EthNFT {
    return new Contract(address, _abi, signerOrProvider) as EthNFT;
  }
}
